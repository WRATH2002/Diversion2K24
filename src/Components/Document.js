...
const Document = () => {
  return (
    <>
      <Navbar data={3} />
      <div className="w-full min-h-[calc(100%-80px)] bg-[black] px-[20%] py-[40px]">
        <div className="w-full h-full flex flex-col justify-center items-start">
          ...
          <span className="leading-[1] text-[22px] md:text-[26px] lg:text-[26px] mt-[40px] text-[##f5f5f7] font-[poppins] text-white w-full">
            Introduction
          </span>
          ...
          <span className="leading-[1] text-[22px] md:text-[18px] lg:text-[18px] mt-[10px] text-[##f5f5f7] font-[poppins] font-normal text-white w-full">
          ...
          <span className="leading-[1] text-[22px] md:text-[18px] lg:text-[18px] mt-[18px] text-[##f5f5f7] font-[poppins] text-white w-full">
            Fall Detection
          </span>
          <span className="leading-normal font-normal text-[17px] md:text-[15px] lg:text-[15px] mt-[10px] font-[poppins] text-[#6b6b6b] w-full overflow-hidden text-ellipsis text-justify">
