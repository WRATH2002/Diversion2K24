    ...
    <>
      ...
      <div className="w-full bg-black h-[calc(100svh-80px)] flex flex-col justify-center items-center px-[15%] ">
        ...
        <div className="w-full h-[50%] flex flex-col justify-center items-center">
          <span className="leading-[1] text-[22px] md:text-[26px] lg:text-[26px] text-[##f5f5f7] text-white font-[poppins] w-full">
            Micro-controller:
            <span className="leading-[1] text-[22px] md:text-[26px] lg:text-[26px] text-[##f5f5f7] text-[#6b6b6b] font-[poppins] w-full ml-[10px]">
              {" "}
              Arduino Uno
            </span>
          </span>
          <br />
          <span className="leading-[1] text-[22px] md:text-[26px] lg:text-[26px] text-[##f5f5f7] text-white font-[poppins] w-full mb-[10px]">
            Modules Used:
          </span>
          <span className="leading-[1] text-[22px] md:text-[26px] lg:text-[26px] text-[##f5f5f7] text-white font-[poppins] w-full">
            <pre className="leading-[1] text-[22px] md:text-[26px] lg:text-[26px] text-[#6b6b6b] font-[poppins] w-full">
              • MPU6050
            </pre>
            <pre className="leading-[1] text-[22px] md:text-[26px] lg:text-[26px] text-[#6b6b6b] font-[poppins] w-full">
              • RTC DS3212
