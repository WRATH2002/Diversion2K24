...
const Segment1 = () => {
  return (
    <div className="w-full md:w-[47%] lg:w-[47%] bg-[] backdrop-blur-sm  h-[calc(100svh-70px)] md:h-full lg:h-full  flex flex-col justify-center items-center md:justify-end md:items-end lg:justify-end lg:items-end px-[0] md:p-[40px] lg:p-[40px] border-b-[2px] md:border-b-[0px] lg:border-b-[0px] border-b-[#414141] ">
      <div className="w-full h-full flex justify-center items-center  text-[white] font-[lato]  ">
        <div className="w-full h-full flex flex-col items-center justify-center ">
          ...
          <span className="text-[29px] md:text-[19px] lg:text-[29px] font-medium mt-[10px] w-full flex justify-start">
            Your device is not connected wiht WiFi
          </span>
